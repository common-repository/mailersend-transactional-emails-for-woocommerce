...
Tags: woo, woocommerce, mailersend, email, ecommerce, shop
...
= 1.2.3 (July 17th 2023) =
* Add HPOS compatibility
* Add fallback to default mailer
* Tested up to the latest WordPress and WooCommerce

= 1.2.2 (May 8th 2023) =
* Fix meta links
* Tested up to the latest WordPress and WooCommerce

= 1.2.1 (July 28th 2022) =
* Tested up to WordPress 6.0.1

= 1.2 (March 23rd 2022) =
* New: CC and BCC settings
* New: invoice.discount_total and order.shipping_method variable
* New: items.*.meta_data variable
